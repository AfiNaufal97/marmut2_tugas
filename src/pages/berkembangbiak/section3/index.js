    ...
    <div>
      <div className="md:hidden">
        ...
        <p className="text-justify text-[18px] mb-[20px] px-[20px] mt-[15px]">
          ...
          Marmut akan dilahirkan setelah berada dalam rahim kurang lebih selama
          59-73 hari. Berat lahir normal bayi Marmut sangat variatif berkisar
          antara 70 hingga 100 gram.{" "}
        </p>
      </div>
